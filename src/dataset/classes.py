...
def get_split_classes(args: CfgNode) -> Dict[str, Any]:
    """
    ...
    # =============== COCO ===================
    # COCO数据集一共1~80一共80个类
    # COCO-20i是把80个类拆分成四组, 每组二个类. 测试小样本学习的性能的时候选择一组20个类作为新类测试小样本学习能力, 剩下的60个类作为基类训练base model
    # 类似于k-fold验证
    name = 'coco'
    ...
    if args.use_split_coco:
        ...
        for i, val_list in enumerate(vals_lists):
            ...
            split_classes[name][i]['train'] = sorted(
                list(set(class_list) - set(val_list)))
    ...
    # =============== Pascal ===================
    # Pascal数据集一共1~20一共20个类
    # Pascal-5i是把20个类拆分成四组, 每组五个类. 测试小样本学习的性能的时候选择一组5个类作为新类测试小样本学习能力, 剩下的15个类作为基类训练base model
    # Pascal-10i是把20个类拆分成两组, 每组十个类. 测试小样本学习的性能的时候选择一组10个类作为新类测试小样本学习能力, 剩下的10个类作为基类训练base model
    # 类似于k-fold验证
    name = 'pascal'
